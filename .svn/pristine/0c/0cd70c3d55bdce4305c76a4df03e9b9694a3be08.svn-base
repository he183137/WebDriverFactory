...
public class WebDriverFactory {
    ...
    public static WebDriver getDriver(String hub, Capabilities capabilities,FirefoxProfile firefoxProfile) {
      return factoryInternal.getDriver(hub, capabilities,firefoxProfile);
    }

    public static WebDriver getDriver(Capabilities capabilities) {
      return factoryInternal.getDriver(capabilities);
    }
    public static WebDriver getDriver(Capabilities capabilities,FirefoxProfile firefoxProfile){
        return factoryInternal.getDriver(capabilities,firefoxProfile);
    }
